...
export default function Footer() {
    return (
        <footer className="bg-white absolute top-[1500px] left-[100px]">
            {/* Top Section */}
            <section className="bg-[#f9f9f9] py-10">
                <div className="max-w-screen-xl mx-auto flex justify-between items-center">
                    ...
                    <div className="flex gap-6">
                        <Image src={"/facebook.png"} width={6} height={6}  alt="fb" className="w-6 h-6 " />
                        <Image src={"/insta.png"} alt="fb" width={6} height={6} className="w-6 h-6 " />
                        <Image src={"/twitter.png"} alt="fb" width={6} height={6} className="w-6 h-6 " />
                    </div>
                </div>
            </section>
